...
| `experiments/coherence_window_4x4.py` | Scaling to 4x4: tests predictions P-A (window universality $w \le S=3$), P-B (boundary-role per-capita concentration: corner 3.50 > edge 2.50 > centre 2.25), and P-C (torus vs open dynamics); sides never mix (ceiling: 100% u-side, age-1: 100% v-side) on both open and torus |
