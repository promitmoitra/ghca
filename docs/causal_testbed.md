...
*Usage doc for the Track-4b package (spec [`causal_testbed_spec.md`](https://github.com/promitmoitra/ghca/blob/main/docs/causal_testbed_spec.md),
plan [`causal_testbed_plan.md`](https://github.com/promitmoitra/ghca/blob/main/docs/causal_testbed_plan.md)). Packages the C-series
