...
- **Core Engine:** `ghca_plasticity.py`
- **Unit Tests:** `tests/test_closed_loop_plasticity.py`, `tests/test_sequential_closed_loop.py`
- **Single-Task Benchmarks:** `experiments/closed_loop_plasticity.py`
- **Sequential Benchmarks:** `experiments/sequential_closed_loop.py`
- **Master Regression Harness:** `reproduce_all.py`
